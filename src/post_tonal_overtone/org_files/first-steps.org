...
(noisey2)
 ...
 #+RESULTS:
 : #<instrument: noisey2>#<synth-node[loading]: post_tonal_overtone.485/noisey2 2246>
...
(noisey2 :attack 0.4 :sustain 0 :release 0.7 :vol 0.3 :length 10)
  ...
  #+RESULTS:
  : #<synth-node[loading]: post_tonal_overtone.485/noisey2 2262>
...
(noisey2 :attack 0 :sustain 0 :release 0.1 :vol 0.3 :length 1)
  ...
  #+RESULTS:
  : #<synth-node[loading]: post_tonal_overtone.485/noisey2 2257>
...
(sin3)
 ...
 #+RESULTS:
 : #<instrument: sin3>#<synth-node[loading]: post_tonal_overtone.core/sin3 2263>
...
(sin3 330)
 ...
 #+RESULTS:
 : #<synth-node[loading]: post_tonal_overtone.core/sin3 2264>
...
(saw1)
 ...
 #+RESULTS:
 : #<instrument: saw1>#<synth-node[loading]: post_tonal_overtone.core/saw1 2272>
...
get sounds.
 ...
 #+BEGIN_SRC clojure :session getting-started :tangle yes 
(definst saw2 [freq 220 attack 0.3 sustain 0.15 release 0.25 vol 0.2 length 5]
...
(saw2)
 ...
 #+RESULTS:
 : #<instrument: saw2>#<synth-node[loading]: post_tonal_overtone.core/saw2 2367>

#+BEGIN_SRC clojure
(saw2 (overtone.algo.chance/ranged-rand 300 302) :vol 3)
#+END_SRC

#+RESULTS:
: #<synth-node[loading]: post_tonal_overtone.core/saw2 2393>
...
#+RESULTS:
: #<synth-node[loading]: post_tonal_ov485/audition-synth 2434>
