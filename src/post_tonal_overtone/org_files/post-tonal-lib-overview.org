...
#+BEGIN_SRC clojure :session getting-started
(use 'post-tonal-overtone.set-class-data)
post-tonal-overtone.set-class-data/cmajtriads
#+END_SRC
...
(load "/Users/a/git-projects/post_tonal_overtone/src/post_tonal_overtone/set-class-data/set-class-data")
#+END_SRC
