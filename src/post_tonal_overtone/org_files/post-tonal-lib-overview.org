...
(noisey-sustained 1)
  ...
  #+RESULTS:
  : #<instrument: noisey-sustained>#<synth-node[loading]: post_tonal_485/noisey-sustained 60>
...
(noisey2 :attack 1 :sustain 0 :release 0.5 :vol 0.3 :length 10)
  ...
  #+RESULTS:
  : #<synth-node[loading]: post_tonal_overtone.485/noisey2 61>
...
Make sure that your data is loaded in a namespace declaration.
 #+BEGIN_SRC clojure :session getting-started :tangle yes 
;; (load "set-class-data")
 #+END_SRC
...
(sin3 330)
 ...
 #+RESULTS:
 : #<synth-node[loading]: post_tonal_overtone.core/sin3 65>
