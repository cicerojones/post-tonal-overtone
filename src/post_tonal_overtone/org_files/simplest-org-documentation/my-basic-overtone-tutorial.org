...
#+RESULTS:
: '((:description "Axiom A.I.R. Mini32 MIDI"  :vendor "M-Audio"  :sinks 0  :sources 2147483647  :name "MIDI"  :overtone.studio.midi/full-device-key (:midi-device "M-Audio" "MIDI" "Axiom A.I.R. Mini32 MIDI" 0)  :info #object(com.sun.media.sound.MidiInDeviceProvider$MidiInDeviceInfo 0x1a34557a "MIDI")  :overtone.studio.midi/dev-num 0  :device #object(com.sun.media.sound.MidiInDevice 0x44fe4ed4 "com.sun.media.sound.MidiInDevice@44fe4ed4")  :version "Unknown version") (:description "Axiom A.I.R. Mini32 HyperControl"  :vendor "M-Audio"  :sinks 0  :sources 2147483647  :name "HyperControl"  :overtone.studio.midi/full-device-key (:midi-device "M-Audio" "HyperControl" "Axiom A.I.R. Mini32 HyperControl" 0)  :info #object(com.sun.media.sound.MidiInDeviceProvider$MidiInDeviceInfo 0x7f06c7fe "HyperControl")  :overtone.studio.midi/dev-num 0  :device #object(com.sun.media.sound.MidiInDevice 0x6e2d40c9 "com.sun.media.sound.MidiInDevice@6e2d40c9")  :version "Unknown version"))
...
#+RESULTS:
: #<synth-node[loading]: user/grainy-ctl 78>
...
#+RESULTS:
: #overtone.studio.inst.Inst{:name "grainy-ctl", :params ({:name "b", :default 0.0, :rate :kr, :value #atom[0.0 0x601d6f90]} {:name "trate", :default 1.0, :rate :kr, :value #atom[1.0 0x2d4b27af]} {:name "amp", :default 0.8, :rate :kr, :value #atom[0.8 0x1285136b]}), :args ("b" "trate" "amp"), :sdef {:name "user/grainy-ctl", :constants [0.0 2.0 1.0 21.0 0.2], :params (0.0 1.0 0.8), :pnames ({:name "b", :index 0} {:name "trate", :index 1} {:name "amp", :index 2}), :ugens ({:args nil, :special 0, :name "Control", :rate 1, :inputs (), :rate-name :kr, :n-outputs 3, :id 393, :outputs ({:rate 1} {:rate 1} {:rate 1}), :n-inputs 0} #<sc-ugen: impulse:ar [1]> #<sc-ugen: buf-dur:kr [1]> #<sc-ugen: mouse-x:kr [2]> #<sc-ugen: binary-op-u-gen:kr [1]> #<sc-ugen: t-grains:ar [9]> #<sc-ugen: out:ar [10]>)}, :group #<synth-group[live]: Inst grainy-ctl Container 74>, :instance-group #<synth-group[live]: Inst grainy-ctl 75>, :fx-group #<synth-group[live]: Inst grainy-ctl FX 76>, :mixer #<synth-node[live]: overtone.stu547/mono-inst-mixer 77>, :bus #<audio-bus: No Name, mono, id 21>, :fx-chain [], :volume #atom[1.0 0x730bdc43], :pan #atom[0.0 0x789fbd2], :n-chans 1}
...
#+RESULTS:
: #<synth-node[loading]: user/slow-grain 85>
